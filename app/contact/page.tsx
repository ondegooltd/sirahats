            ...
            >
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  Have questions about our baskets, wholesale opportunities, or
                  custom orders? We're here to help.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">customer@sirahats.com</p>
                    <p className="text-gray-600">wholesale@sirahats.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+233 30000-0099</p>
